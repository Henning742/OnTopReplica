...
namespace OnTopReplica.SidePanels {
    partial class OptionsPanel : SidePanel {
        ...
        private void LocalizePanel() {
            ...
            lblClickThroughToggle.Text = Strings.MenuClickThrough;
        ...
        public override void OnFirstShown(MainForm form) {
            ...
            txtClickThrough.Text = Settings.Default.HotKeyClickThrough;
        }
        ...
        public override void OnClosing(MainForm form) {
            ...
            Settings.Default.HotKeyClickThrough = txtClickThrough.Text;
